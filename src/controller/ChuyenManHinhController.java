...
import cuahangmevabe.SanPhamJPanel;
import cuahangmevabe.HoaDonJPanel;
import cuahangmevabe.KhachHangJPanel;
import cuahangmevabe.ThongKeJPanel;
...
public class ChuyenManHinhController {
    ...
    public void setView(JPanel jpnItem, JLabel jlbItem){
        ...
        jpnItem.setBackground(new Color(204,255,255));
        jlbItem.setBackground(new Color(204,255,255));
